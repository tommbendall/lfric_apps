  ...
  subroutine bl_imp2_code(nlayers, seg_len,                   &
    ...
    do i = 1, seg_len
      if (map_2d(1,i) == 71) then
        write(log_scratch_space, *) 'BL IMP2, wetrho_in_wth(71) = ', wetrho_in_wth(map_wth(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, exner_in_w3(71) = ', exner_in_w3(map_w3(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        ...
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, ntml_2d(71) = ', ntml_2d(map_2d(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, cumulus_2d(71) = ', cumulus_2d(map_2d(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, dtheta_bl(71) = ', dtheta_bl(map_wth(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, diss_u(71) = ', diss_u(map_w3(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, diss_v(71) = ', diss_v(map_w3(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, m_v(71) = ', m_v(map_wth(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, m_cl(71) = ', m_cl(map_wth(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, m_ci(71) = ', m_ci(map_wth(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, m_s(71) = ', m_s(map_wth(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, cf_area(71) = ', cf_area(map_wth(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, cf_ice(71) = ', cf_ice(map_wth(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, cf_liq(71) = ', cf_liq(map_wth(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, cf_bulk(71) = ', cf_bulk(map_wth(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, cca(71) = ', cca(map_wth(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, ccw(71) = ', ccw(map_wth(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, rh_crit_wth(71) = ', rh_crit_wth(map_wth(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, dsldzm(71) = ', dsldzm(map_wth(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, mix_len_bm(71) = ', mix_len_bm(map_wth(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, wvar(71) = ', wvar(map_wth(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, gradrinr(71) = ', gradrinr(map_wth(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, tau_dec_bm(71) = ', tau_dec_bm(map_wth(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, tau_hom_bm(71) = ', tau_hom_bm(map_wth(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, tau_mph_bm(71) = ', tau_mph_bm(map_wth(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, rhokh_bl(71) = ', rhokh_bl(map_w3(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, bq_bl(71) = ', bq_bl(map_wth(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, bt_bl(71) = ', bt_bl(map_wth(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        ...
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, thetal_inc_leonard_wth(71) = ', &
             thetal_inc_leonard_wth(map_wth(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, mt_inc_leonard_wth(71) = ', mt_inc_leonard_wth(map_wth(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, z_lcl(71) = ', z_lcl(map_2d(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, inv_depth(71) = ', inv_depth(map_2d(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, qcl_at_inv_top(71) = ', qcl_at_inv_top(map_2d(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, zh_nonloc(71) = ', zh_nonloc(map_2d(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, zh_2d(71) = ', zh_2d(map_2d(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, zhsc_2d(71) = ', zhsc_2d(map_2d(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        ...
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, fqw_star_w3(71) = ', fqw_star_w3(map_w3(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
        write(log_scratch_space, *) 'BL IMP2, ftl_star_w3(71) = ', ftl_star_w3(map_w3(1,i))
        call log_event(log_scratch_space, LOG_LEVEL_DEBUG)
      end if
    end do
