...
subroutine helmholtz_operator_code(stencil_size,                       &
  ...
  real(kind=r_solver), dimension(ncell_3d_2, ndf_w3, ndf_w2), intent(in) :: compound_div
  real(kind=r_solver), dimension(ncell_3d_3, ndf_w3, ndf_wt), intent(in) :: p3theta
  real(kind=r_solver), dimension(ncell_3d_4, ndf_wt, ndf_w2), intent(in) :: ptheta2v
  real(kind=r_solver), dimension(ncell_3d_5, ndf_w3, ndf_w3), intent(in) :: m3_exner_star
